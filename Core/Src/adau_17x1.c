...
/* Private variables ---------------------------------------------------------*/
// adau17x1_reg adau17x1_reg_defaults[38] = {
// 	{(uint16_t)REG_SAMPLE_RATE_SETTING_IC_1_ADDR		,           (uint16_t)REG_SAMPLE_RATE_SETTING_IC_1_BYTE    , &R0_SAMPLE_RATE_SETTING_IC_1_Default[0]		},		//00
// 	{(uint16_t)REG_DSP_RUN_REGISTER_IC_1_ADDR				,   (uint16_t)REG_DSP_RUN_REGISTER_IC_1_BYTE             , &R1_DSP_RUN_REGISTER_IC_1_Default[0]			    	},		//01
// 	{(uint16_t)REG_CLKCTRLREGISTER_IC_1_ADDR				,       (uint16_t)REG_CLKCTRLREGISTER_IC_1_BYTE               , &R2_CLKCTRLREGISTER_IC_1_Default[0]					},		//02
// 	{(uint16_t)REG_PLLCRLREGISTER_IC_1_ADDR		,               (uint16_t)REG_PLLCRLREGISTER_IC_1_BYTE  , &R3_PLLCRLREGISTER_IC_1_Default[0]	},		//03
// 	// {(uint8_t)		, (uint8_t)    , &[0]		},		//04
// 	// SIGMA_WRITE_DELAY( DEVICE_ADDR_IC_1, R4_DELAY_IC_1_SIZE, R4_DELAY_IC_1_Default );
// 	{(uint16_t)REG_SERIAL_PORT_CONTROL_0_IC_1_ADDR ,             (uint16_t)R5_SERIAL_PORT_CONTROL_REGISTERS_IC_1_SIZE, &R5_SERIAL_PORT_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_ALC_CONTROL_0_IC_1_ADDR ,                     (uint16_t)R6_ALC_CONTROL_REGISTERS_IC_1_SIZE, &R6_ALC_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_MICCTRLREGISTER_IC_1_ADDR,                    (uint16_t)REG_MICCTRLREGISTER_IC_1_BYTE, &R7_MICCTRLREGISTER_IC_1_Default[0]},
// 	{(uint16_t)REG_RECORD_PWR_MANAGEMENT_IC_1_ADDR ,             (uint16_t)R8_RECORD_INPUT_SIGNAL_PATH_REGISTERS_IC_1_SIZE, &R8_RECORD_INPUT_SIGNAL_PATH_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_ADC_CONTROL_0_IC_1_ADDR ,                     (uint16_t)R9_ADC_CONTROL_REGISTERS_IC_1_SIZE, &R9_ADC_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_PLAYBACK_MIXER_LEFT_CONTROL_0_IC_1_ADDR ,     (uint16_t)R10_PLAYBACK_OUTPUT_SIGNAL_PATH_REGISTERS_IC_1_SIZE, &R10_PLAYBACK_OUTPUT_SIGNAL_PATH_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_CONVERTER_CTRL_0_IC_1_ADDR ,                  (uint16_t)R11_CONVERTER_CONTROL_REGISTERS_IC_1_SIZE, &R11_CONVERTER_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_DAC_CONTROL_0_IC_1_ADDR ,                     (uint16_t)R12_DAC_CONTROL_REGISTERS_IC_1_SIZE, &R12_DAC_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_SERIAL_PORT_PAD_CONTROL_0_IC_1_ADDR ,         (uint16_t)R13_SERIAL_PORT_PAD_CONTROL_REGISTERS_IC_1_SIZE, &R13_SERIAL_PORT_PAD_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_COMM_PORT_PAD_CTRL_0_IC_1_ADDR ,              (uint16_t)R14_COMMUNICATION_PORT_PAD_CONTROL_REGISTERS_IC_1_SIZE, &R14_COMMUNICATION_PORT_PAD_CONTROL_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_JACKREGISTER_IC_1_ADDR,                       (uint16_t)REG_JACKREGISTER_IC_1_BYTE, &R15_JACKREGISTER_IC_1_Default[0]},
// 	{(uint16_t)PROGRAM_ADDR_IC_1,                                (uint16_t)PROGRAM_SIZE_IC_1, &Program_Data_IC_1[0]},
// 	{(uint16_t)PROGRAM_ADDR_IC_1,                                (uint16_t)PROGRAM_SIZE_IC_1, &Program_Data_IC_1[0]},
// 	{(uint16_t)PROGRAM_ADDR_IC_1,                                (uint16_t)PROGRAM_SIZE_IC_1, &Program_Data_IC_1[0]},
// 	{(uint16_t)PROGRAM_ADDR_IC_1,                                (uint16_t)PROGRAM_SIZE_IC_1, &Program_Data_IC_1[0]},
// 	{(uint16_t)PROGRAM_ADDR_IC_1,                                (uint16_t)PROGRAM_SIZE_IC_1, &Program_Data_IC_1[0]},
// 	{(uint16_t)REG_DSP_ENABLE_REGISTER_IC_1_ADDR,                (uint16_t)REG_DSP_ENABLE_REGISTER_IC_1_BYTE, &R21_DSP_ENABLE_REGISTER_IC_1_Default[0]},
// 	{(uint16_t)REG_CRC_IDEAL_1_IC_1_ADDR ,                       (uint16_t)R22_CRC_REGISTERS_IC_1_SIZE, &R22_CRC_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_GPIO_0_CONTROL_IC_1_ADDR ,                    (uint16_t)R23_GPIO_REGISTERS_IC_1_SIZE, &R23_GPIO_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_NON_MODULO_RAM_1_IC_1_ADDR ,                  (uint16_t)R24_NON_MODULO_REGISTERS_IC_1_SIZE, &R24_NON_MODULO_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_WATCHDOG_ENABLE_IC_1_ADDR ,                   (uint16_t)R25_WATCHDOG_REGISTERS_IC_1_SIZE, &R25_WATCHDOG_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)REG_SAMPLE_RATE_SETTING_IC_1_ADDR,                (uint16_t)REG_SAMPLE_RATE_SETTING_IC_1_BYTE, &R26_SAMPLE_RATE_SETTING_IC_1_Default[0]},
// 	{(uint16_t)REG_ROUTING_MATRIX_INPUTS_IC_1_ADDR,              (uint16_t)REG_ROUTING_MATRIX_INPUTS_IC_1_BYTE, &R27_ROUTING_MATRIX_INPUTS_IC_1_Default[0]},
// 	{(uint16_t)REG_ROUTING_MATRIX_OUTPUTS_IC_1_ADDR,             (uint16_t)REG_ROUTING_MATRIX_OUTPUTS_IC_1_BYTE, &R28_ROUTING_MATRIX_OUTPUTS_IC_1_Default[0]},
// 	{(uint16_t)REG_SERIAL_DATAGPIO_PIN_CONFIG_IC_1_ADDR,         (uint16_t)REG_SERIAL_DATAGPIO_PIN_CONFIG_IC_1_BYTE, &R29_SERIAL_DATAGPIO_PIN_CONFIG_IC_1_Default[0]},
// 	{(uint16_t)REG_DSP_SLEW_MODES_IC_1_ADDR,                     (uint16_t)REG_DSP_SLEW_MODES_IC_1_BYTE, &R30_DSP_SLEW_MODES_IC_1_Default[0]},
// 	{(uint16_t)REG_SERIAL_PORT_SAMPLE_RATE_SETTING_IC_1_ADDR,    (uint16_t)REG_SERIAL_PORT_SAMPLE_RATE_SETTING_IC_1_BYTE, &R31_SERIAL_PORT_SAMPLE_RATE_SETTING_IC_1_Default[0]},
// 	{(uint16_t)REG_CLOCK_ENABLE_REG_0_IC_1_ADDR ,                (uint16_t)R32_CLOCK_ENABLE_REGISTERS_IC_1_SIZE, &R32_CLOCK_ENABLE_REGISTERS_IC_1_Default[0]},
// 	{(uint16_t)PROGRAM_ADDR_IC_1,                                (uint16_t)PROGRAM_SIZE_IC_1, &Program_Data_IC_1[0]},
// 	{(uint16_t)PARAM_ADDR_IC_1,                                  (uint16_t)PARAM_SIZE_IC_1, &Param_Data_IC_1[0]},
// 	{(uint16_t)REG_SAMPLE_RATE_SETTING_IC_1_ADDR,                (uint16_t)REG_SAMPLE_RATE_SETTING_IC_1_BYTE, &R35_SAMPLE_RATE_SETTING_IC_1_Default[0]},
// 	{(uint16_t)REG_DSP_RUN_REGISTER_IC_1_ADDR,                   (uint16_t)REG_DSP_RUN_REGISTER_IC_1_BYTE, &R36_DSP_RUN_REGISTER_IC_1_Default[0]},
// 	{(uint16_t)REG_DEJITTER_REGISTER_CONTROL_IC_1_ADDR,          (uint16_t)REG_DEJITTER_REGISTER_CONTROL_IC_1_BYTE, &R37_DEJITTER_REGISTER_CONTROL_IC_1_Default[0]},
// 	{(uint16_t)REG_DEJITTER_REGISTER_CONTROL_IC_1_ADDR,          (uint16_t)REG_DEJITTER_REGISTER_CONTROL_IC_1_BYTE, &R38_DEJITTER_REGISTER_CONTROL_IC_1_Default[0]},
// };

uint8_t ADAU_DSP_SAMPLING_RATE_0 = 0x7F;
uint8_t ADAU_DSP_RUN_0 = 0x00;
uint8_t ADAU_CLOCK_CONTROL = 0x07;	//0x0F;
uint8_t ADAU_PLL_CONTROL[6] = {0x00, 0x01, 0x00, 0x00, 0x20, 0x03};
uint8_t ADAU_SERIAL_PORT[2] = {0x01, 0x00};
uint8_t ADAU_ALC[4] = {0x00, 0x00, 0x00, 0x00};
uint8_t ADAU_DIG_MIG = 0x00;
uint8_t ADAU_REC_POWER_MGMT[8] = {0x00, 0x51, 0x05, 0x51, 0x05, 0x00, 0x00, 0x00};
uint8_t ADAU_ADC_CONTROL[3] = {0x13, 0x00, 0x00};
uint8_t ADAU_PLAY_MIXER[14] = {0x61, 0x00, 0x61, 0x00, 0x03, 0x09, 0x01, 0xE7, 0xE7, 0xE6, 0xE6, 0xE7, 0x00, 0x0F};
uint8_t ADAU_CONVERTER[2] = {0x00, 0x00};
uint8_t ADAU_DAC_CONTROL[3] = {0x03, 0x00, 0x00};
uint8_t ADAU_SERIAL_PORT_PAD = 0xAA;
uint8_t ADAU_CONTROL_PORT_PAD[2] = {0xAA, 0x00};
uint8_t ADAU_JACK_DETECT = 0x08;
uint8_t ADAU_CLEAR_RAM_0[60] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 , 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t ADAU_CLEAR_RAM_1[15] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t ADAU_DSP_ENABLE = 0x01;
uint8_t ADAU_CRC[5] = {0x7F, 0x3D, 0x7F, 0x7F, 0x01};
uint8_t ADAU_GPIO_PIN_CONTROL[4] = {0x00, 0x00, 0x00, 0x0B};
uint8_t ADAU_NON_MODULO_RAM[2] = {0x10, 0x00};
uint8_t ADAU_WATCHDOG_EN[5] = {0x00, 0x04, 0x00, 0x00, 0x00};
uint8_t ADAU_DSP_SAMPLING_RATE_1 = 0x7F;
uint8_t ADAU_SERIAL_IN_CONTROL = 0x00;
uint8_t ADAU_SERIAL_OUT_CONTROL = 0x00;
uint8_t ADAU_SERIAL_DATA_CONFIG = 0x0F;
uint8_t ADAU_DSP_SLEW_MODE = 0x00;
uint8_t ADAU_SERIAL_PORT_SAMPLING_RATE = 0x00;
uint8_t ADAU_CLOCK_ENABLE[2] = {0x7F, 0x03};
uint8_t ADAU_PROGRAM_RAM_00[60] = {0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 0xE0, 0x00, 0x00, 0x00, 0xFF, 0x34, 0x00, 0x00, 0x00, 0xFF, 0x2C, 0x00, 0x00, 0x00, 0xFF, 0x54, 0x00, 0x00, 0x00, 0xFF, 0x5C, 0x00, 0x00, 0x00, 0xFF, 0xF5, 0x08, 0x20, 0x00, 0xFF, 0x38, 0x00, 0x00, 0x00, 0xFF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 0xE8, 0x0C, 0x00, 0x00};
uint8_t ADAU_PROGRAM_RAM_01[60] = {0xFE, 0x30, 0x00, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xE8, 0x07, 0x20, 0x08, 0x00, 0x00, 0x06, 0xA0, 0x00, 0xFF, 0xE0, 0x00, 0xC0, 0x00, 0xFF, 0x80, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t ADAU_PROGRAM_RAM_02[60] = {0xFF, 0x00, 0x00, 0x00, 0x00, 0xFE, 0xC0, 0x22, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 0xE8, 0x1E, 0x00, 0x00, 0xFF, 0xE8, 0x01, 0x20, 0x00, 0xFF, 0xD8, 0x01, 0x03, 0x00, 0x00, 0x07, 0xC6, 0x00, 0x00, 0xFF, 0x08, 0x00, 0x00, 0x00, 0xFF, 0xF4, 0x00, 0x20, 0x00, 0xFF, 0xD8, 0x07, 0x02, 0x00, 0xFD, 0xA5, 0x08, 0x20, 0x00, 0x00, 0x00, 0x00, 0xE2, 0x00};
uint8_t ADAU_PROGRAM_RAM_03[60] = {0xFD, 0xAD, 0x08, 0x20, 0x00, 0x00, 0x08, 0x00, 0xE2, 0x00, 0xFF, 0xE8, 0x08, 0x20, 0x00, 0x00, 0x10, 0x00, 0xE2, 0x00, 0x00, 0x15, 0x08, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0xF0, 0x00, 0x00, 0x05, 0x08, 0x20, 0x00, 0x00, 0x0D, 0x08, 0x22, 0x00, 0x00, 0x20, 0x00, 0xE2, 0x00, 0x00, 0x1D, 0x08, 0x20, 0x00, 0x00, 0x28, 0x00, 0xE2, 0x00};
uint8_t ADAU_PROGRAM_RAM_04[60] = {0xFF, 0xF5, 0x08, 0x60, 0x00, 0xFF, 0x80, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x
uint8_t ADAU_PROGRAM_RAM_20[60] = {0x02, 0x88, 0x00, 0xE2, 0x00, 0x00, 0x85, 0x08, 0x20, 0x00, 0x02, 0x90, 0x00, 0xE2, 0x00, 0x02, 0x90, 0x00, 0xC0, 0x00, 0x00, 0xB7, 0xFF, 0x20, 0x00, 0x02, 0x98, 0x00, 0xE2, 0x00, 0x00, 0x8D, 0x08, 0x20, 0x00, 0xFF, 0xDE, 0x23, 0x02, 0x00, 0x02, 0x8D, 0x08, 0x20, 0x00, 0x02, 0x9D, 0x08, 0x22, 0x00, 0x02, 0xA0, 0x00, 0xE2, 0x00, 0x02, 0xA5, 0x08, 0x20, 0x00};
uint8_t ADAU_PROGRAM_RAM_21[40] = {0xFD, 0xB8, 0x00, 0xE2, 0x00, 0x02, 0xA5, 0x08, 0x20, 0x00, 0xFD, 0xB0, 0x00, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 0xC0, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t ADAU_PARAMETER_RAM_0[60] = {0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0xC5, 0x00, 0x80, 0x00, 0x00, 0x00, 0x7E, 0x14, 0x7B, 0x00, 0x78, 0x51, 0xEC, 0x00, 0x6E, 0xD9, 0x17, 0x00, 0x62, 0x0C, 0x4A, 0x00, 0x52, 0x4D, 0xD3};
uint8_t ADAU_PARAMETER_RAM_1[60] = {0x00, 0x40, 0x00, 0x00, 0x00, 0x2B, 0xC6, 0xA8, 0x00, 0x16, 0x45, 0xA2, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xE9, 0xBA, 0x5E, 0xFF, 0xD4, 0x39, 0x58, 0xFF, 0xC0, 0x00, 0x00, 0xFF, 0xAD, 0xB2, 0x2D, 0xFF, 0x9D, 0xF3, 0xB6, 0xFF, 0x91, 0x26, 0xE9, 0xFF, 0x87, 0xAE, 0x14, 0xFF, 0x81, 0xEB, 0x85, 0xFF, 0x80, 0x00, 0x00, 0xFF, 0x81, 0xEB, 0x85, 0xFF, 0x87, 0xAE, 0x14};
uint8_t ADAU_PARAMETER_RAM_2[60] = {0xFF, 0x91, 0x26, 0xE9, 0xFF, 0x9D, 0xF3, 0xB6, 0xFF, 0xAD, 0xB2, 0x2D, 0xFF, 0xC0, 0x00, 0x00, 0xFF, 0xD4, 0x39, 0x58, 0xFF, 0xE9, 0xBA, 0x5E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x16, 0x45, 0xA2, 0x00, 0x2B, 0xC6, 0xA8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x52, 0x4D, 0xD3, 0x00, 0x62, 0x0C, 0x4A, 0x00, 0x6E, 0xD9, 0x17, 0x00, 0x78, 0x51, 0xEC, 0x00, 0x7E, 0x14, 0x7B};
uint8_t ADAU_PARAMETER_RAM_3[60] = {0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x16, 0x45, 0xA2, 0x00, 0x2B, 0xC6, 0xA8, 0x00, 0x40, 0x00, 0x00, 0x00, 0x52, 0x4D, 0xD3, 0x00, 0x62, 0x0C, 0x4A, 0x00, 0x6E, 0xD9, 0x17, 0x00, 0x78, 0x51, 0xEC};
uint8_t ADAU_PARAMETER_RAM_4[60] = {0x00, 0x7E, 0x14, 0x7B, 0x00, 0x80, 0x00, 0x00, 0x00, 0x7E, 0x14, 0x7B, 0x00, 0x78, 0x51, 0xEC, 0x00, 0x6E, 0xD9, 0x17, 0x00, 0x62, 0x0C, 0x4A, 0x00, 0x52, 0x4D, 0xD3, 0x00, 0x40, 0x00, 0x00, 0x00, 0x2B, 0xC6, 0xA8, 0x00, 0x16, 0x45, 0xA2, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xE9, 0xBA, 0x5E, 0xFF, 0xD4, 0x39, 0x58, 0xFF, 0xC0, 0x00, 0x00, 0xFF, 0xAD, 0xB2, 0x2D};
uint8_t ADAU_PARAMETER_RAM_5[60] = {0xFF, 0x9D, 0xF3, 0xB6, 0xFF, 0x91, 0x26, 0xE9, 0xFF, 0x87, 0xAE, 0x14, 0xFF, 0x81, 0xEB, 0x85, 0xFF, 0x80, 0x00, 0x00, 0xFF, 0x81, 0xEB, 0x85, 0xFF, 0x87, 0xAE, 0x14, 0xFF, 0x91, 0x26, 0xE9, 0xFF, 0x9D, 0xF3, 0xB6, 0xFF, 0xAD, 0xB2, 0x2D, 0xFF, 0xC0, 0x00, 0x00, 0xFF, 0xD4, 0x39, 0x58, 0xFF, 0xE9, 0xBA, 0x5E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
uint8_t ADAU_PARAMETER_RAM_6[60] = {0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xFF, 0xF0, 0x00, 0x00, 0x03, 0x47, 0x00, 0x01, 0x47, 0xAE, 0xFF, 0x80, 0x14, 0xBB, 0xFF, 0x80, 0x2F, 0x77, 0xFF, 0x80, 0xA1, 0xD3, 0xFF, 0x81, 0xE6, 0x59, 0xFF, 0x85, 0x66, 0x34, 0xFF, 0x8E, 0xD0, 0x88, 0xFF, 0xA6, 0x98, 0x9E};
uint8_t ADAU_PARAMETER_RAM_7[60] = {0xFF, 0xAF, 0x67, 0x44, 0x00, 0x14, 0xB4, 0xB0, 0xFF, 0xE4, 0xB4, 0xB0, 0x00, 0x1C, 0x2C, 0xD4, 0x00, 0x3D, 0x33, 0x60, 0x00, 0x2C, 0x29, 0x04, 0xFF, 0x80, 0x28, 0x93, 0xFF, 0x80, 0x55, 0x1D, 0xFF, 0x81, 0x1C, 0x96, 0xFF, 0x83, 0x36, 0x76, 0xFF, 0x89, 0x00, 0x2F, 0xFF, 0x98, 0x02, 0xD5, 0xFF, 0xC1, 0x6A, 0x3A, 0xFF, 0xD4, 0x91, 0xD0, 0x00, 0x12, 0xE7, 0x05};
uint8_t ADAU_PARAMETER_RAM_8[16] = {0x00, 0x09, 0x17, 0x8E, 0x00, 0x0B, 0x86, 0x14, 0x00, 0x40, 0x73, 0x2A, 0x00, 0x1E, 0xE4, 0x88};
uint8_t ADAU_DSP_SAMPLING_RATE_2 = 0x01;
uint8_t ADAU_DSP_RUN_1 = 0x01;
uint8_t ADAU_DEJITTER_CONTROL_0 = 0x00;
uint8_t ADAU_DEJITTER_CONTROL_1 = 0x03;

adau17x1_reg adau17x1_reg_defaults[131] = {
...
void adau_init(void)
{
	...
	if(ack == HAL_OK && soundCt.bDspSoundFlag != I2C_STAT_TIMEOUT)
	{
		...
		for(i = 0; i < 130; i++)
		{
			...
			HAL_I2C_Mem_Write(&hi2c2,ADAU_ADDR_WRITE,adau17x1_reg_defaults[i].addr,I2C_MEMADD_SIZE_16BIT,adau17x1_reg_defaults[i].isi,adau17x1_reg_defaults[i].size,100);
			if(i == 3)
			{
				HAL_Delay(1000);
			}
